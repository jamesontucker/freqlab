...
export function MainLayout() {
    ...
    return (
        <div className="h-screen flex flex-col bg-bg-primary">
                                    ...
                                    {projects.length === 0 ? (
                                        ...
                                        <>
                                            ...
                                            <p className="text-text-secondary mb-6 max-w-md">
                                                Choose a plugin from the sidebar to continue working on it, or create a
                                                new one.
                                            </p>
                                            <button
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="mt-1.5 flex items-center justify-between">
                            <p className="text-xs text-text-muted">Display name only (does not rename files)</p>
                    ...
                    <div>
                        ...
                        <p className="text-xs text-text-muted mb-2">Provides context for code suggestions</p>
                        <textarea
                            id="edit-description"
                        ...
                        <div className="mt-1.5 flex justify-end">
                            <span
                                className={`text-xs ${
                                    editDescription.length >= 260 ? 'text-warning' : 'text-text-muted'
                                }`}
                            >
            ...
            <Modal isOpen={showDeleteConfirm} onClose={() => setShowDeleteConfirm(false)} title="Delete Plugin">
                <div className="space-y-4">
                    <p className="text-text-secondary">
                        Are you sure you want to delete{' '}
                        <span className="font-semibold text-text-primary">{activeProject?.name}</span>? This will
                        permanently remove all project files and built plugins.
                    </p>
